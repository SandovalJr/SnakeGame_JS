  ...
  */
  ...
  Tone_core_Type = (function (Tone) {
    ...
    Tone.prototype.notationToSeconds = function (notation, bpm, timeSignature) {
      ...
      timeSignature = this.defaultArg(
        timeSignature,
        getTransportTimeSignature()
      );
      var beatTime = 60 / bpm;
      if (notation === "1n") {
        notation = "1m";
    ...
    Tone.prototype.transportTimeToSeconds = function (
      transportTime,
      bpm,
      timeSignature
    ) {
    ...
    Tone.prototype.secondsToTransportTime = function (
      seconds,
      bpm,
      timeSignature
    ) {
    ...
    Tone.prototype.toNotation = function (time, bpm, timeSignature) {
      ...
      var retNotation = toNotationHelper.call(
        this,
        time,
        bpm,
        timeSignature,
      ...
      var retTripletNotation = toNotationHelper.call(
        this,
        time,
        bpm,
        timeSignature,
    ...
    function toNotationHelper(time, bpm, timeSignature, testNotations) {
      var seconds = this.toSeconds(time);
      var threshold = this.notationToSeconds(
      ...
      for (var i = 0; i < testNotations.length; i++) {
        var notationTime = this.notationToSeconds(
          testNotations[i],
          bpm,
          timeSignature
        );
  ...
  audioin = (function () {
    ...
    p5.AudioIn.prototype.setSource = function (num) {
      ...
      if (
        ...
        console.log(
          "set source to " + p5sound.inputSources[self.currentSource].id
        );
      } else {
  ...
  filter = (function () {
    ...
    p5.Filter.prototype.freq = function (freq, time) {
      ...
      if (typeof freq === "number") {
        ...
        self.biquad.frequency.cancelScheduledValues(
          this.ac.currentTime + 0.01 + t
        );
        self.biquad.frequency.exponentialRampToValueAtTime(
          freq,
    ...
    p5.Filter.prototype.res = function (res, time) {
      ...
      if (typeof res == "number") {
        ...
        self.biquad.Q.linearRampToValueAtTime(
          res,
          self.ac.currentTime + 0.02 + t
        );
      } else if (res) {
  ...
  delay = (function () {
    ...
    p5.Delay.prototype.feedback = function (f) {
      ...
      if (typeof f !== "number") {
        ...
        this._leftGain.gain.exponentialRampToValueAtTime(
          f,
          this.ac.currentTime
        );
        this._rightGain.gain.exponentialRampToValueAtTime(
          f,
          this.ac.currentTime
        );
      }
      ...
      if (elapsedTime - tatumTime <= -0.02) {
        ...
        for (var i in this.syncedParts) {
          ...
          for (var j in thisPart.phrases) {
            ...
            if (
              phraseArray[bNum] !== 0 &&
              (this.metroTicks < phraseArray.length || !thisPhrase.looping)
            ) {
